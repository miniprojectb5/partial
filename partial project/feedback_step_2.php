...
<div id="table"> 
    <div class="tr">
     ...
     <div class="td">
        ...
        <div class="tdd">
<input type="button" onClick="window.location='mainhome.html'" value="HOME">&nbsp;&nbsp;&nbsp;&nbsp;
        	<input type="button"onClick="window.location='feedback.php'" value="BACK">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="NEXT" />
        </div>
